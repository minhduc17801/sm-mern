...
const Form = () => {
    ...
    const login = async (values, formikBag) => {
    ...
    const register = async (values, formikBag) => {
        const formData = new FormData();
        console.log(values);
    };

    const handleSubmit = async (values, formikBag) => {
        if (isLogin) await login(values, formikBag);
        if (isRegister) await register(values, formikBag);
    };
